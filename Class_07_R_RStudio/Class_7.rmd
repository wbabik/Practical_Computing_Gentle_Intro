...
"Download - *version\_number* - for Windows" As of the time of
writing the currect R version was 4.2.1.  
...
`str()` function. Please consult manual of `str()` by invoking `?str` and test yourself some of the examples provided in the manual.
